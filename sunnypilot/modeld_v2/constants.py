...
class MetaV0814:
  ...
  # no GAS_PRESS/BRAKE_PRESS: the old struct only carries gas_pressed inside the
  # disengage block (no brake-pressed field at all), and fill_model_msg.py already
  # guards this block behind hasattr() so omitting both attributes skips it cleanly
